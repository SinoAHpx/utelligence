...
export default function ClearChatsButton() {
	...
	const chatExists = Object.keys(localStorage).some((key) => key.startsWith("chat_"));
	...
	return (
		<Dialog>
			<DialogTrigger asChild>
				<Button variant="ghost" className="justify-start gap-2 w-full h-9 px-3" disabled={disabled}>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>确定要删除所有聊天记录吗？此操作无法撤销。</DialogDescription>
				</DialogHeader>
				<DialogFooter>
					<DialogClose asChild>
