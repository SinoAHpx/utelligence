...
import { extractNumericData } from "../../../../utils/data/visualization/analysis-helpers";
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>对总体参数进行点估计和区间估计</CardDescription>
			</CardHeader>
			<CardContent className="space-y-6">
				...
				<div>
					...
					<ul className="list-disc pl-6 space-y-2 text-sm text-muted-foreground">
						<li>
							<span className="font-medium">点估计</span>
							：使用样本统计量（均值、方差等）作为总体参数的最佳估计值。
						</li>
						<li>
							<span className="font-medium">区间估计</span>
							：在给定置信水平下，计算包含总体参数的区间范围。
						</li>
						<li>
							<span className="font-medium">标准误</span>
							：样本统计量（如均值）的抽样分布的标准差，反映了估计值的精确度。
						</li>
						<li>
							<span className="font-medium">95% 置信区间</span>
							：意味着在多次重复抽样中，约95%的区间会包含真实的总体参数。
						</li>
					</ul>
				</div>
			</CardContent>
