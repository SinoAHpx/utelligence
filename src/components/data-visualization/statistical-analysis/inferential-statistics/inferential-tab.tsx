...
import { type InferentialCategory, InferentialFilter } from "./inferential-filter";
...
export function InferentialStatisticsTab({
	...
	if (!columnData || columnData.length === 0) {
		return (
			<Alert>
				<AlertDescription>暂无数据可供分析，请确保选择了有效的数据列。</AlertDescription>
			</Alert>
		);
	}
	...
	return (
		<div className="space-y-6">
			<InferentialFilter activeCategory={category} onCategoryChange={setCategory} />
