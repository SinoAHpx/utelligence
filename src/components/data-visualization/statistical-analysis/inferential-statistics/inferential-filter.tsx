...
export type InferentialCategory = "all" | "parameter-estimation" | "normality-test" | "t-test";
 ...
 * 推断性统计分类过滤组件
 */
export function InferentialFilter({ activeCategory, onCategoryChange }: InferentialFilterProps) {
	const categories = [
		{ id: "all", name: "全部指标" },
