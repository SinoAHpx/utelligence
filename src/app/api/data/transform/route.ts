...
function scaleData(data: any[], columnName: string, minValue: number = 0, maxValue: number = 1): any[] {
...
function regexReplace(data: any[], columnName: string, pattern: string, replacement: string): any[] {
    try {
